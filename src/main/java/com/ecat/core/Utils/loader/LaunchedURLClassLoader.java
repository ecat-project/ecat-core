...
package com.ecat.core.Utils.loader;
...
import com.ecat.core.Utils.loader.jar.Handler;
...
public class LaunchedURLClassLoader extends URLClassLoader {
	...
	/**
	 * Define a package before a {@code findClass} call is made. This is necessary
	 * to
	 ...
	 * 
	 * url must from a JarFile getUrl() or 
	 * url's URLStreamHandler is com.ecat.core.Utils.loader.jar.Handler.Handler
	 * 
	...
	/**
	 * Add multiple URLs to the class loader.
	 * urls @see addURL(URL url)
	...
	private void clearCache(URLConnection connection) throws IOException {
		...
		if (jarFile instanceof com.ecat.core.Utils.loader.jar.JarFile) {
			((com.ecat.core.Utils.loader.jar.JarFile) jarFile).clearCache();
		}
	}
	...
	/**
	 * The different types of call made to define a package. We track these for
	 * exploded
	 * jars so that we can detect packages that should have manifest attributes
	 * applied.
	 */
